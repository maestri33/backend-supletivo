...
class Profile(models.Model):
    ...
    pix_key_type = models.CharField("tipo da chave Pix", max_length=10, null=True, blank=True)
    ...
    marital_status = models.CharField("estado civil", max_length=32, null=True, blank=True)
    nationality = models.CharField("nacionalidade", max_length=64, null=True, blank=True)
